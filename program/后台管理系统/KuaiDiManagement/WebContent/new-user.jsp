        ...
        <div class="span9">
		  <div class="row-fluid">
			<div class="page-header">
				<h1>新的用户 <small>用户注册</small></h1>
			</div>
			<form name="RegPoster" class="form-horizontal" action="servlet/AddPosterServlet" method="post">
				<fieldset>
					...
					<div class="control-group">
						<label class="control-label" for="usercompany">用户公司</label>
						<div class="controls">
							<input type="text" class="input-xlarge" name="usercompany" />
						</div>
					</div>
					<div class="control-group">
					...
					<div class="form-actions">
						<input type="submit" class="btn btn-success btn-large" value="保存并创建" /> <a class="btn" href="PosterManagement.jsp">取消</a>
					</div>					
				</fieldset>
			</form>
		  </div>
